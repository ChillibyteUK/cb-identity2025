...
<section id="<?php echo esc_attr( $block_id ); ?>" class="cb-work-index">
	<div class="cb-work-index__filter-bar py-4 px-4 px-md-5">
		<div class="id-container py-4 px-4 px-md-5 d-flex justify-content-start gap-4 align-items-center cb-work-index__filters" data-service-map='<?php echo esc_attr( $service_map_json ); ?>' data-theme-map='<?php echo esc_attr( $theme_map_json ); ?>'>
