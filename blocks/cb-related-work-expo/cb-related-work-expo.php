<?php
/**
 * CB Related Work EXPO Block Template
 *
...
// Theme is always 'Expo' for this block.
...
// Run query if theme_id is found (Expo block always needs theme)
if ( $theme_id ) {
	$posts = array();
